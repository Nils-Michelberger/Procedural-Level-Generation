...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        private bool m_Jump, m_PreviouslyGrounded, m_Jumping, m_IsGrounded, m_IsFlying;
        ...
        private void Update()
        {
            ...
            if (Input.GetButtonDown("Jump") && !m_Jump && !m_IsFlying)
            {
                m_Jump = true;
            }
        ...
        private void FixedUpdate()
        {
                ...
                (advancedSettings.airControl || m_IsGrounded))
            {
                ...
                if (m_IsFlying)
                {
                    m_RigidBody.AddForce(new Vector3(desiredMove.x, 0f, desiredMove.z) * SlopeMultiplier() * 5, ForceMode.Impulse);
